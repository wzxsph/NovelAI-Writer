...
| 命令 | 说明 |
|------|------|
| `/novelai continue --chapter N --words 3000` | 续写章节 |
| `/novelai continue --chapter N --mode polish` | 润色章节 |
| `/novelai continue --chapter N --mode expand` | 扩写大纲为正文 |
| `/novelai verify --chapter N --scope all` | 校验一致性 |

### 状态查看
| 命令 | 说明 |
|------|------|
| `/novelai timeline --chapter N` | 事件时间线 |
...
| `/novelai chapters --range 1-30` | 章节概览 |
